...
class SmallStraightScoringStrategyTest {
    ...
    static Stream<Arguments> score_retruns_SMALL_STRAIGHT_score_when_a_small_straight_is_read() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource
    void score_retruns_SMALL_STRAIGHT_score_when_a_small_straight_is_read( Roll roll) {
